...
#Setting plateau/ grid size, but will use these values in the move method
...
#Gets the job done, and includes the grid size, requires a more eloquent and abbreviated
#update
def move(forward)
  if @direction == "N"
    if @y + 1 < @@ymax
...
#This method is super beautiful and great
...
# The original turn method, have found a better one to replace this one
# def left
#   if @direction == "N"
#     @direction = "W"
#   elsif
